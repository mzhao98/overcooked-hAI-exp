...
export default class OvercookedSinglePlayerTask_AdaptFourStrategy{
    constructor ({
        container_id,
	    player_index,
        npc_policies,
	...
	this.weight_assignment = [0.25, 0.25, 0.25, 0.25];
	this.human_history = [];

	this.robot_predicted_human_history_proba_0 = [];
	this.robot_predicted_human_history_proba_1 = [];
	this.robot_predicted_human_history_proba_2 = [];
	this.robot_predicted_human_history_proba_3 = [];

	this.robot_true_human_history_proba_0 = [];
	this.robot_true_human_history_proba_1 = [];
	this.robot_true_human_history_proba_2 = [];
	this.robot_true_human_history_proba_3 = [];
    ...
    init() {
	    ...
	    for (let npc_index in this.npc_policies) {
            ...
            let npc_a_2_proba = this.npc_policies[npc_index][2](this.state, this.game);
            let npc_a_3_proba = this.npc_policies[npc_index][3](this.state, this.game);

            var npc_a_0 = Action.INDEX_TO_ACTION[argmax(npc_a_0_proba)];
            var npc_a_1 = Action.INDEX_TO_ACTION[argmax(npc_a_1_proba)];
            var npc_a_2 = Action.INDEX_TO_ACTION[argmax(npc_a_2_proba)];
            var npc_a_3 = Action.INDEX_TO_ACTION[argmax(npc_a_3_proba)];
            ...
            for (var idx = 0; idx < npc_a_0_proba.length; idx++) {
                ...
                var r2_action_prob = npc_a_2_proba[idx];
                var r3_action_prob = npc_a_3_proba[idx];

                var weighted_proba = (r0_action_prob * this.weight_assignment[0]) + (r1_action_prob * this.weight_assignment[1]) + (r2_action_prob * this.weight_assignment[2]) + (r3_action_prob * this.weight_assignment[3]);
            ...
            this.timestep_callback({
                ...
                datetime: +new Date(),
                strategy_weights: this.weight_assignment
            });
    ...
    activate_response_listener () {
        $(document).on("keydown", (e) => {
            ...
            for (let npc_index in this.npc_policies) {
                ...
                let npc_a_2_h_proba = this.npc_policies[npc_index][2](this.state, this.game);
                let npc_a_3_h_proba = this.npc_policies[npc_index][3](this.state, this.game);

                let npc_a_0_h_max_prob = max(npc_a_0_h_proba);
                let npc_a_1_h_max_prob = max(npc_a_1_h_proba);
                let npc_a_2_h_max_prob = max(npc_a_2_h_proba);
                let npc_a_3_h_max_prob = max(npc_a_3_h_proba);
                ...
                if (h_action_idx != 4){
                    if (this.human_history.length === max_history_length){
                        ...
                        this.robot_true_human_history_proba_2.shift();
                        this.robot_true_human_history_proba_3.shift();
                        ...
                        this.robot_true_human_history_proba_2.push(npc_a_2_h_proba[h_action_idx]);
                        this.robot_true_human_history_proba_3.push(npc_a_3_h_proba[h_action_idx]);


                        this.robot_predicted_human_history_proba_0.shift();
                        this.robot_predicted_human_history_proba_1.shift();
                        this.robot_predicted_human_history_proba_2.shift();
                        this.robot_predicted_human_history_proba_3.shift();
                        ...
                        this.robot_predicted_human_history_proba_2.push(npc_a_2_h_max_prob);
                        this.robot_predicted_human_history_proba_3.push(npc_a_3_h_max_prob);
                    }
                    else{
                        this.human_history.push(h_action_idx);
                    ...
                    // console.log("model weights ORIG probs = "+ this.weight_assignment);
                    ...
                    for (var idx = 0; idx < this.human_history.length; idx++) {
                        ...
                        var r2_prob_human_action_TRUE = this.robot_true_human_history_proba_2[idx];
                        var r3_prob_human_action_TRUE = this.robot_true_human_history_proba_3[idx];
                        ...
                        var r2_prob_human_action_PRED = this.robot_predicted_human_history_proba_2[idx];
                        var r3_prob_human_action_PRED = this.robot_predicted_human_history_proba_3[idx];
                        ...
                        robot_2_g = robot_2_g + ((gamma * (max_history_length - idx)) * Math.abs(r2_prob_human_action_PRED-r2_prob_human_action_TRUE));
                        robot_3_g = robot_3_g + ((gamma * (max_history_length - idx)) * Math.abs(r3_prob_human_action_PRED-r3_prob_human_action_TRUE));
                    }
                    // console.log("g values = "+ robot_0_g + " , "+ robot_1_g+ " , "+ robot_2_g+ " , "+ robot_3_g);
                    if (robot_0_g + robot_1_g + robot_2_g + robot_3_g === 0){
                        robot_0_g = 0.25;
                        robot_1_g = 0.25;
                        robot_2_g = 0.25;
                        robot_3_g = 0.25;
                        ...
                        var sum_g_values = robot_0_g+ robot_1_g + robot_2_g + robot_3_g;
                        robot_0_g = robot_0_g/sum_g_values;
                        robot_1_g = robot_1_g/sum_g_values;
                        robot_2_g = robot_2_g/sum_g_values;
                        robot_3_g = robot_3_g/sum_g_values;
                        // console.log("g values NORMALIZED = "+ robot_0_g + " , "+ robot_1_g);

                        robot_0_g = 1-robot_0_g;
                        robot_1_g = 1-robot_1_g;
                        robot_2_g = 1-robot_2_g;
                        robot_3_g = 1-robot_3_g;
                        ...
                        if (robot_0_g + robot_1_g + robot_2_g + robot_3_g === 0){
                            ...
                            var sum_w_values = robot_0_g+ robot_1_g + robot_2_g + robot_3_g;
                            robot_0_g = robot_0_g/sum_w_values;
                            robot_1_g = robot_1_g/sum_w_values;
                            robot_2_g = robot_2_g/sum_w_values;
                            robot_3_g = robot_3_g/sum_w_values;
                        }

                    }
                    this.weight_assignment = [robot_0_g, robot_1_g, robot_2_g, robot_3_g];
                    // console.log("model weights NEW probs = "+ this.weight_assignment);
